...
Route::get('/informasi-user', [App\Http\Controllers\FaqController::class, 'informasi'])->name('faq');

Route::get('/', [App\Http\Controllers\CampurController::class, 'index']);

Route::get('/cek-session-idpaketmst', function () {
    return response()->json(['idpaketmst' => session('idpaketmst')]);
});


Route::get('listpaket/{id}', [App\Http\Controllers\CampurController::class, 'paketsayadtl']);

Route::post('mulaiujianpublic/{id}', [App\Http\Controllers\CampurController::class, 'mulaiujianpublic']);

Route::post('mulaibelajarpublic/{id}', [App\Http\Controllers\CampurController::class, 'mulaiujianpublic']);

Route::get('ujianpublic/{id}', [App\Http\Controllers\CampurController::class, 'ujian']);

Route::get('belajarpublic/{id}', [App\Http\Controllers\CampurController::class, 'belajar']);

Route::post('updatejawabanpublic', [App\Http\Controllers\CampurController::class, 'updatejawaban']);

Route::get('detailhasilpublic/{id}', [App\Http\Controllers\CampurController::class, 'detailhasil']);

Route::post('selesaiujianpublic', [App\Http\Controllers\CampurController::class, 'selesaiujianpublic']);

Route::post('lanjutsesipublic', [App\Http\Controllers\CampurController::class, 'lanjutsesi']);

Route::post('cekpasswordpaket', [App\Http\Controllers\UserController::class, 'cekPasswordPaket']);
...
Route::get('informasi-public', [App\Http\Controllers\CampurController::class, 'informasi']);
...
Route::middleware([IsAdminOrAff::class])->group(function () {
    ...
    Route::get('/exportsoal/pembahasan/{jns}/{id}', [App\Http\Controllers\PDFController::class, 'exportsoalpembahasan']);
});
...
Route::middleware([IsAdmin::class, CheckUserSession::class])->group(function () {
    ...
    Route::get('faq-admin', [App\Http\Controllers\FaqController::class, 'indexAdmin']);
    Route::post('storefaq', [App\Http\Controllers\FaqController::class, 'store']);
    Route::post('/updatefaq', [App\Http\Controllers\FaqController::class, 'update']);
    Route::post('/hapusfaq', [App\Http\Controllers\FaqController::class, 'destroy']);
...
Route::middleware([IsUser::class])->group(function () {
    ...
    Route::post('createordermanual', [App\Http\Controllers\PaymentController::class, 'createordermanual']);
    ...
    Route::get('panduanpembayaran/{id}', [App\Http\Controllers\UserController::class, 'panduanpembayaran'])->name('panduanpembayaran');
    ...
    Route::get('belipaketktg', [App\Http\Controllers\UserController::class, 'belipaketsubktg']);
    ...
    Route::get('belipaket', [App\Http\Controllers\UserController::class, 'belipaket']);
    ...
    Route::post('/mulaibelajar/{id}', [App\Http\Controllers\UserController::class, 'mulaibelajar']);
    ...
    Route::get('belajar/{id}', [App\Http\Controllers\UserController::class, 'belajar']);
