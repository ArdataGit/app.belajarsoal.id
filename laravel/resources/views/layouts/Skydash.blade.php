    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center d-sm-none"
                ...
                <a class="navbar-brand brand-logo mr-5" href="https://apps.belajarsoal.id/">
                    <img src="{{ asset($template->logo_besar) }}" class="mr-2" alt="logo"
                        style="max-width: 100%; height: auto;" />
                </a>
                <a class="navbar-brand brand-logo-mini" href="https://apps.belajarsoal.id/">
                    <img src="{{ asset($template->logo_kecil) }}" alt="logo"
                        style="max-width: 100%; height: auto;" />
                </a>
            </div>
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background:#171A26;">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item {{ $menu == 'faq' ? 'active' : '' }}">
                        <a class="nav-link _nav-link" href="{{ url('faq') }}" _ceklink="faq"
                            _link="{{ url('faq') }}">
                            <i class="ti-help menu-icon"></i>
            ...
            <div class="main-panel">
                ...
                <footer class="footer" style="background:#171A26;">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-white text-center text-sm-left d-block d-sm-inline-block">BelajarSoal.id
                            {{ now()->year }}</span>
                        {{-- <span
