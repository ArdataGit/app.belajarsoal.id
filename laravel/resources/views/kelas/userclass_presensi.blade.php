            ...
            <div class="row" style="margin-top:32px;">
              <div class="col-12">  
                    ...
                    <div class="box-class">
                        ...
                        <a class="btn btn-warning" href="{{url('userclass/'.$idpaketdtl.'/'.$kelas->id.'/room')}}">Live Class</a>
                        <a class="btn btn-warning active" href="{{url('userclass/'.$idpaketdtl.'/'.$kelas->id.'/presensi')}}">Data Presensi</a>
                        @if($sudah_presensi)
