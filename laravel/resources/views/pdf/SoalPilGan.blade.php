...
<body>
    ...
    <div>
        <center>
            <h2 class="center-title">Soal Latihan<br>{{ $paketsoalmst->judul }}</h2>
        </center>

        <div style="margin-bottom:15px;">
            <div style="float:left; margin-top:40px;">
                <b>Jumlah Soal : </b>{{ count($paketsoaldtl) }} Soal
                <br>
                <b>Nama :</b>
                <br>
                <b>Kelas :</b>
            ...
            <div
                style="float:right; border: 1px solid black; padding: 10px; width: 220px; height: 130px; text-align:center; margin-top:10px;">
                <!-- Content for the box on the right side -->
                <b>Nilai:</b>
                <br>
    ...
    @if (count($paketsoalktg) > 0)
        <center>
            <h3 style="margin-bottom:5px">Soal Pilihan Ganda</h3>
        </center>
    @endif
