...
';
                                            ...
                                            <div id="latihankecermatan" class="tab-pane {{ $tab == 'latihankecermatan' ? 'active' : '' }}">
                                                ...
                                                @php                                                                                                                
                                                        ...
                                                        <li class="row d-block">
                                                        <button style="width:50px;" class="mt-4 mb-4 btn btn-sm btn-info btn-icon-text d-none" id="cermatkatback" onclick="cermatkatback()"> <i class="ti ti-arrow-left"></i> </button>    
                                                        </li>
                                                        ';
                                            ...
                                            <div id="hasillatihan" class="tab-pane {{ $tab == 'hasillatihan' ? 'active' : '' }}">
                                                ...
                                                @if ( $usebobot)
                                                    ...
                                                    @if(!$bobothasil)
                                                        ...
                                                        <button class="btn btn-info rounded-3 w-100 py-3 mt-2 text-white" onclick="latihan()">

                                                        <h5 class="mb-0 p-0">Silahkan lanjut latihan lainnya</h5>
