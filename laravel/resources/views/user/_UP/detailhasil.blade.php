                                            ...
                                            <div class="row mt-3" style="justify-content: center">
                                                <div class="col-12 col-md-3"
                                                    ...
                                                    <div class="px-3 py-5 card-border"
                                                        ...
                                                        <div class=""><span
                                                                style="font-size: 36pt;color: #106571;font-weight: bold;display: block;">{{ $upaketsoalmst->point <= 0 ? 0 : $upaketsoalmst->point }}</span>
                                                        </div>
                                                ...
                                                @foreach ($soalmst as $item)
                                                    <div class="col-12 col-md-3"
                                                        style="background: #EFFFF1 !important;max-width:24% !important;margin-left:0.5%;margin-right:0.5%;border-radius:10px">
                                                        <div class="px-3 py-5 card-border"
                                                            style="text-align:center;border-radius:10px;display:flex;flex-direction:column;justify-content:center">
                                                            ...
                                                            <div class=""><span
                                                                    style="font-size: 26pt;color: #106571;font-weight: bold;display: block;">{{ $item->point <= 0 ? 0 : $item->point }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
