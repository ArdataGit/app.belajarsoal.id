            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card card-border">
                    <div class="card-body">
                        ...
                        <h3 class="font-weight-bold mb-3 text-white"><b>Pembelian</b></h3>
                        <div class="card card-inverse-info mb-3">
                            <div class="card-body">
                                <p class="card-text">
                                <h4 class="text-white"><i class="ti-info text-wite"></i> Informasi</h4>
                                <div class="informasi text-white">
                                    <ul>
                                        <li>Pembayaran diverifikasi otomatis oleh sistem.</li>
                                        <li>Apabila dalam 30 menit setelah pembayaran namun pembelian belum terkonfirmasi,
                                            silahkan hubungi kami melalui WhatsApp {{ $template->no_hp }}</li>
                                    </ul>
                                </div>
                                </p>
                            </div>
                                        ...
                                        <ul class="nav nav-pills btn-menu-hasil" role="tablist">
                                            <li class="nav-item">
                                                <a class="btn btn-sm btn-primary nav-link btn-tab-hasil active"
                                                    data-toggle="pill" href="#menunggu"><i class="ti-timer"></i> Menunggu
                                                    pembayaran</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="btn btn-sm btn-primary nav-link btn-tab-hasil" data-toggle="pill"
                                                    href="#batal"><i class="ti-close"></i> Pembayaran batal</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="btn btn-sm btn-primary nav-link btn-tab-hasil" data-toggle="pill"
                                                    href="#selesai"><i class="ti-check"></i> Pembayaran selesai</a>
                                            </li>
                                        </ul>
                                            ...
                                            <div id="menunggu" class="tab-pane active"><br>
                                                    ...
                                                    @if ($idstatus == 0)
                                                        <div class="row mb-3">
                                                            <div class="col-md-9 text-white">
                                                                ...
                                                                <p>{{ Carbon\Carbon::parse($key->created_at)->translatedFormat('l, d
                                                                                                                        F Y , H:i:s') }}
                                                                </p>
                                                                @if ($key->channel_r)
                                                                    <div class="row mt-3 mb-3" style="align-items:center">
                                                                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                                                            <img src="{{ $key->channel_r->img }}"
                                                                                alt="" width="100%">
                                                                        </div>
                                                                        <div
                                                                            ...
                                                                            <p>Total Pembayaran :
                                                                                {{ formatRupiahCekGratis($key->harga) }}
                                                                            </p>
                                                                            <p style="margin-bottom:0px">Batas Pembayaran :
                                                                                <span
                                                                                    class="text-danger">{{ Carbon\Carbon::parse($key->expired)->translatedFormat('l,
                                                                                                                                                        d F Y , H:i:s') }}
                                                                                    WIB</span></p>
                                                                        </div>
                                                                    </div>
                                                                @else
                                                                    <p>Total Pembayaran :
                                                                        {{ formatRupiahCekGratis($key->harga) }}</p>
                                                                    <p style="margin-bottom:0px">Batas Pembayaran : <span
                                                                            class="text-danger">{{ Carbon\Carbon::parse($key->expired)->translatedFormat('l,
                                                                                                                                        d F Y , H:i:s') }}
                                                                            WIB</span></p>
                                                                @endif
                                                            ...
                                                            <div class="col-md-3" style="text-align:right">
                                                                <label class="badge mb-4 mt-1 text-white"
                                                                    style="border: 1px solid white; border-radius: 1rem;">
                                                                    Menunggu Pembayaran
                                                                </label>
                                                                <p>
                                                                    @if (isset($key->payment_url))
                                                                        <a target="_blank" href="{{ $key->payment_url }}"
                                                                            type="button"
                                                                            class="mt-1 btn btn-primary btn-sm btn-fw"
                                                                            style="color: white !important;">
                                                                            Panduan Pembayaran
                                                                        </a>
                                                                    @else
                                                                        <a target="_blank"
                                                                            href="panduanpembayaran/{{ $key->merchant_order_id }}"
                                                                            type="button"
                                                                            class="mt-1 btn btn-primary btn-sm btn-fw"
                                                                            style="color: white !important;">
                                                                            Panduan Pembayaran
                                                                ...
                                                                <p><button data-bs-toggle="modal"
                                                                        ...
                                                                        type="button"
                                                                        class="mt-1 btn btn-danger btn-sm btn-fw">Batalkan
                                                                        Pembelian</button></p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="modal fade" id="myModal{{ $key->id }}">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <form method="post" id="formHapus_{{ $key->id }}"
                                                                        class="form-horizontal">
                                                                        @csrf
                                                                        <div class="modal-body">
                                                                            Apakah kamu yakin ingin membatalkan pembelian
                                                                            paket
                                                                            {{ $key->paket_mst_r->judul }}?
                                                                        </div>
                                                                        <!-- Modal footer -->
                                                                        <div class="modal-footer" id="modal-batal-beli">
                                                                            ...
                                                                            <button type="button"
                                                                                class="btn-batalkan btn btn-md btn-danger"
                                                                                idform="{{ $key->id }}">Ya,
                                                                                Batalkan</button>
                                                ...
                                                @empty
                                                    <center><img class="mb-3 img-no"
                                                            src="{{ asset('image/global/no-transaksi.png') }}"
                                                            alt=""></center>
                                                    <br>
                                                ...
                                                @forelse($data->where('status',2) as $key)
                                                    <div class="row mb-3">
                                                        <div class="col-md-8 text-white">
                                                            <p>No.Pembelian : <b>{{ $key->merchant_order_id }}</b></p>
                                                            <p>Pembelian :
                                                                {{ $key->paket_mst_r->judul ?? 'Judul tidak tersedia' }}
                                                            </p>
                                                            <p>{{ Carbon\Carbon::parse($key->created_at)->translatedFormat('l, d
                                                                                                                    F Y , H:i:s') }}
                                                            </p>
                                                            @if ($key->channel_r)
                                                                <div class="row mt-3 mb-3" style="align-items:center">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                                                        <p>{{ $key->channel_r->nama }}</p>
                                                                        <p style="margin-bottom:0px">Total Pembayaran :
                                                                            {{ formatRupiahCekGratis($key->harga) }}</p>
                                                        ...
                                                        <div class="col-md-4" style="text-align:right">
                                                            <label class="badge mb-4 mt-1 text-white"
                                                                style="border: 2px solid white; border-radius: 1rem;">Pembayaran
                                                                Batal</label>
