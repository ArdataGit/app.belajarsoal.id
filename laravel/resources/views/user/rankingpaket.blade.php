        ...
        <div class="card-body">
          ...
          <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active text-light" aria-current="page">Peringkat {{$datapaket->judul}}</li>
          ...
          <h3 class="font-weight-bold text-light"><b>Peringkat Peserta</b></h3>
