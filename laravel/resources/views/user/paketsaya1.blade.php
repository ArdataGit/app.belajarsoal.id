                    ...
                    <div class="card-bodyx">
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active text-white" aria-current="page">{{ $subkategori->judul }}</li>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-center mb-3"
                                                    ...
                                                    <div class="col-8">
                                                        ...
                                                        <h4 class="fs-6 mb-0 ml-3 text-white"><b>{{ $key->judul }}</b></h4>
                                                ...
                                                <div class="mt-3 mb-3">
                                                    ...
                                                    <div class="text-xs fw-500 text-white" style="color:#555">Berlaku hingga:</div>

                                                    <div class="fw-600 text-sm text-white">{{ tglIndo($cekdata->aktif_sampai) }}</div>
                                                    @endif
