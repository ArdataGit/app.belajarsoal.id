                    ...
                    <div class="card-body">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Paket Saya dsadas</li>
                                                    ...
                                                    <div class="col-12 col-sm-3 mt-3"
                                                        ...
                                                        <div class="px-3 py-5 card-border"
                                                            ...
                                                            <div class=""><span
                                                                    ...
                                                                    @if ($key->bobot)
                                                                        {{ $key->nilai <= 0 ? 0 : check_decimal((float) ($key->nilai * (float) ($key->bobot / 100.0))) }}
                                                                    @else
                                                                        {{ $key->nilai <= 0 ? 0 : check_decimal($key->nilai) }}
                                                                    @endif
                                                                </span>
                                                            </div>
                                                            @if ($upaketsoalmst->is_kkm == 1)
                                                                <h6 class="fw-bold mt-3 text-white">Passing Grade
                                                                    {{ $key->kkm }}
                                                                </h6>
                                                                <h6>
                                                                    @if ($key->nilai >= $key->kkm)
                                                            ...
                                                            <div class="tab-pane-soal tab-pane fade {{ $key->no_soal == 1 ? 'show active' : '' }}"
                                                                ...
                                                                <div class="mb-3 py-3 card-border"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <h4
                                                                                class="mb-0 mt-0 d-flex align-items-center">
                                                                    ...
                                                                    <div class="form-group">
                                                                        @if ($upaketsoalmst->jenis_penilaian == 1)
                                                                            ...
                                                                            @if ($key->f)
                                                                                <div
                                                                                    class="form-check {{ $key->jawaban == 'f' && $upaketsoalmst->bagi_jawaban == 1 ? '_form-check-success' : '_form-check-danger' }} {{ $key->jawaban_user == 'f' ? '_form-check-user' : '' }}">
                                                                                    <label class="form-check-label">
                                                                                        <input type="radio"
                                                                                            class="form-check-input _radio"
                                                                                            disabled
                                                                            ...
                                                                            @if ($key->g)
                                                                                <div
                                                                                    class="form-check {{ $key->jawaban == 'g' && $upaketsoalmst->bagi_jawaban == 1 ? '_form-check-success' : '_form-check-danger' }} {{ $key->jawaban_user == 'g' ? '_form-check-user' : '' }}">
                                                                                    <label class="form-check-label">
                                                                                        <input type="radio"
                                                                                            class="form-check-input _radio"
                                                                                            disabled
                                                                            ...
                                                                            @if ($key->h)
                                                                                <div
                                                                                    class="form-check {{ $key->jawaban == 'h' && $upaketsoalmst->bagi_jawaban == 1 ? '_form-check-success' : '_form-check-danger' }} {{ $key->jawaban_user == 'h' ? '_form-check-user' : '' }}">
                                                                                    <label class="form-check-label">
                                                                                        <input type="radio"
                                                                                            class="form-check-input _radio"
                                                                                            disabled
