                    ...
                    <div class="card-bodyx w-100">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active text-white" aria-current="page">{{ $kategori->judul }}
                                </li>
                            </ol>
                        </nav>
                        <p class="card-description">
                        <h3 class="font-weight-bold text-white"><b>Pilih {{ $kategori->judul }}</b></h3>
                        </p>
                        <div class="row mt-4">
                                    ...
                                    <div class="card">
                                        <div class="card-body py-4">
                                            <div class="row align-items-center mb-3" style="flex-wrap: nowrap !important;">
                                                ...
                                                <div class="col-8">
                                                    <h4 class="fs-6 mb-0 text-white ml-3"><b>{{ $key->judul }}</b></h4>
                                                    <div class="text-sm mt-2 ml-3 text-white">{!! $key->ket !!}</div>
                                                </div>
                                            </div>
                                            <a href="{{ url('paketsaya') }}/{{ Crypt::encrypt($key->id) }}"
