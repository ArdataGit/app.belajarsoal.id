                                                ...
                                                function detailkats(&$kategoris, $matkats, $isroot)
                                                {
                                                    ...
                                                    foreach ($matkats as $id => $kat) {
                                                        if ($id && isset($kategoris[$id])) {
                                                            echo '
                                                                                                                                                <li class="row mx-0 md-4 d-inline-block" id="kat-' .
                                                                $id .
                                                                '" katid="' .
                                                                $id .
                                                                '">
                                                                ...
                                                                if ($m->jenis == 1) {
                                                                    echo '
                                                                        ...
                                                                        '" type="button" class="rounded-pill btn btn-md btn-primary btn-block btn-icon-text">
                                                                                                                                                                                    <i class="fa fa-edit btn-icon-prepend"></i> Mode Tryout
                                                                                                                                                                                </button>
                                                        ...
                                                        if ($id && isset($kategoris[$id])) {
                                                            ...
                                                            echo '
                                                                ...
                                                                ');">
                                                                                                                                                    ...
                                                                                                                                                    <ul class=" d-none p-0" style="margin: 0 -2rem">
                                                                                                                                                ';
