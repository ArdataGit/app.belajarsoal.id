                            ...
                            <div class="col-xl-9 col-md-8 col-sm-12 col-xs-12">
                                        ...
                                        <div class="tab-pane fade {{$key->no_soal == 1 ? 'show active' : ''}}"
                                            ...
                                            <div class="question-footer d-flex justify-content-between">
                                                ...
                                                <span style="float:right;padding-bottom:30px;">
                                                    @if (!$loop->last)
                                                        <button idsoal="{{ $key->id + 1 }}" type="button" class="btn-next-back btn btn-sm btn-primary btn-rounded btn-fw mr-3"
                                                            style="border-radius:20px" @if ($loop->iteration == $gratis_ujian) data-limit="true" @endif>
                                                            Selanjutnya
                                ...
                                <div class="col-xl-3 col-md-3 col-sm-3 col-xs-3">
                                    ...
                                    <div class="mb-4 card-border p-3 br-10">
                                        ...
                                        <button type="button" class="btn-block btn btn-primary btn-sm" id="btn-submit-ujian"
