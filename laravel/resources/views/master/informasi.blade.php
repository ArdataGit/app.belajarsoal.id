                                            ...
                                            <td width="1%" class="_align_center">
                                                <div class="btn-group">
                                                    <span data-toggle="tooltip" data-placement="left" title="Lihat Gambar">
                                                        <button
                                                            onclick="modalImage('{{$key->judul}}','{{asset($key->gambar)}}')"
                    ...
                    <form method="post" id="formData_{{$key->id}}" class="form-horizontal">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="ket[]" id="ket_{{$key->id}}" rows="5" class="form-control"
                                    placeholder="Ringkasan">{{$key->ket}}</textarea>
                            </div>

                            <div class="form-group">
                                <label for="isi_{{$key->id}}">Isi<span class="bintang">*</span></label>
                                <textarea name="isi[]" id="isi_{{$key->id}}" rows="5" class="form-control content_"
                                    placeholder="Isi">{{$key->isi}}</textarea>
                            </div>
                            ...
                            {{-- <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="input-foto custom-file-input" id="gambar_{{$key->id}}"
                                            name="gambar[]" idlabel="label-gambar-{{$key->id}}">
                                        <label id="label-gambar-{{$key->id}}" class="custom-file-label"
                ...
                <form method="post" id="_formData" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="ket_add" id="ket_add" rows="5" class="form-control"
                                placeholder="Ringkasan"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="isi_add">Isi<span class="bintang">*</span></label>
                            <textarea name="isi_add" id="isi_add" rows="5" class="form-control content_"
                                placeholder="Isi"></textarea>
                        </div>

                        {{-- <div class="form-group">
                            <label>Gambar<span class="bintang">*</span> <span
                                    class="input-keterangan">(jpg/jpeg/png)</span></label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="input-foto custom-file-input" id="gambar_add"
                                        name="gambar_add" idlabel="label-gambar-add">
                                    <label id="label-gambar-add" class="custom-file-label"
                                        style="border-radius: .25rem;">Pilih file</label>
                                </div>
                            </div>
                        </div> --}}
