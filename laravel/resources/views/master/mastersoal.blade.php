...
<div class="form-group">
    ...
    <input value="0" type="number" class="form-control int" id="point_a_add" name="point_a_add" step="0.1" min="-9999" placeholder="Point Pilihan A">
</div>
...
<div class="form-group">
    ...
    <input value="0" type="number" class="form-control int" id="point_b_add" name="point_b_add" step="0.1" min="-9999" placeholder="Point Pilihan B">
</div>
...
<div class="form-group">
    ...
    <input value="0" type="number" class="form-control int" id="point_c_add" name="point_c_add" step="0.1" min="-9999" placeholder="Point Pilihan C">
</div>
...
<div class="form-group">
    ...
    <input value="0" type="number" class="form-control int" id="point_d_add" name="point_d_add" step="0.1" min="-9999" placeholder="Point Pilihan D">
</div>
...
<div class="form-group">
    ...
    <input value="0" type="number" class="form-control int" id="point_e_add" name="point_e_add" step="0.1" min="-9999" placeholder="Point Pilihan E">
</div>
...
<div class="form-group">
    ...
    <input value="0" type="number" class="form-control int" id="point_f_add" name="point_f_add" step="0.1" min="-9999" placeholder="Point Pilihan F">
</div>
...
<div class="form-group">
    ...
    <input value="0" type="number" class="form-control int" id="point_g_add" name="point_g_add" step="0.1" min="-9999" placeholder="Point Pilihan G">
</div>
...
<div class="form-group">
    ...
    <input value="0" type="number" class="form-control int" id="point_h_add" name="point_h_add" step="0.1" min="-9999" placeholder="Point Pilihan H">
</div>
...
<script>
  $(document).ready(function(){
    ...
    // Fix z-index conflict antara modal dan CKEditor
    $.fn.modal.Constructor.prototype._enforceFocus = function() {};
    
    // Konfigurasi CKEditor yang lebih baik
   // Konfigurasi CKEditor yang lebih baik dengan toolbar lengkap
    var ckeditorConfig = {
        height: 350,
        toolbar: [
            // Toolbar 1: Clipboard, Undo, Redo, Styles
            { name: 'clipboard', items: ['Cut', 'Copy', 'Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Redo'] },
            { name: 'editing', items: ['Find', 'Replace', '-', 'SelectAll', '-', 'SpellChecker', 'Scayt'] },
            
            // Toolbar 2: Formatting & Text
            { name: 'basicstyles', items: ['Bold', 'Italic', 'Underline', 'Strikethrough', 'Subscript', 'Superscript', '-', 'ClearFormat', 'RemoveFormat'] },
            { name: 'fonts', items: ['Font', 'FontSize'] },
            
            // Toolbar 3: Colors & Highlighting
            { name: 'colors', items: ['TextColor', 'BGColor'] },
            
            // Toolbar 4: Paragraph & List
            { name: 'paragraph', items: ['NumberedList', 'BulletedList', '-', 'Outdent', 'Indent', '-', 'Blockquote', 'CreateDiv', '-', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyBlock', '-', 'BidiLtr', 'BidiRtl'] },
            
            // Toolbar 5: Links & Media
            { name: 'links', items: ['Link', 'Unlink', 'Anchor', 'AnchorDialog'] },
            { name: 'insert', items: ['Image', 'Flash', 'Table', 'HorizontalRule', 'Smiley', 'SpecialChar', 'PageBreak', 'Iframe'] },
            
            // Toolbar 6: Styles & Format
            { name: 'styles', items: ['Styles', 'Format', 'Font', 'FontSize'] },
            
            // Toolbar 7: Math & Advanced
            { name: 'math', items: ['Mathjax'] },
            { name: 'document', items: ['Source', 'Preview', 'Print', '-', 'Templates'] },
            
            // Toolbar 8: About & Help
        ...
        mathJaxLib: 'https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.9/MathJax.js?config=TeX-AMS_CHTML',
        contentsCss: [
        ...
        // Link default attributes
        defaultLinkTarget: '_blank'
    };
    
    // Inisialisasi CKEditor untuk textarea dengan class content_
    $('.content_').each(function(){
        var elementId = $(this).attr('id');
        
        // Jika belum diinisialisasi
        if (!CKEDITOR.instances[elementId]) {
            var editor = CKEDITOR.replace(elementId, ckeditorConfig);
            
            // Setup event handler untuk memastikan modal tetap fokus
            editor.on('instanceReady', function(evt) {
                var editable = evt.editor.editable();
                
                // Fix untuk contenteditable
                editable.attachListener(editable.root, 'click', function() {
                    return true;
                });
                
                // Pastikan modal bisa di-drag
                $('.modal').draggable({
                    handle: '.modal-header'
                });
            });
    ...
    // Fix untuk modal tambah
    $('#modal-tambah').on('shown.bs.modal', function (e) {
        setTimeout(function() {
            CKEDITOR.instances.soal_add.focus();
        }, 100);
    });
