              ...
              <form method="post" id="formData" class="form-horizontal">
                @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" step="0.1" class="form-control int" id="point_a" name="point_a[]" placeholder="Point Pilihan A" value="{{$data->point_a}}">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" step="0.1" class="form-control int" id="point_b" name="point_b[]" placeholder="Point Pilihan B" value="{{$data->point_b}}">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" step="0.1" class="form-control int" id="point_c" name="point_c[]" placeholder="Point Pilihan C" value="{{$data->point_c}}">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" step="0.1" class="form-control int" id="point_d" name="point_d[]" placeholder="Point Pilihan D" value="{{$data->point_d}}">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" step="0.1" class="form-control int" id="point_e" name="point_e[]" placeholder="Point Pilihan E" value="{{$data->point_e}}">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" step="0.1" class="form-control int" id="point_f" name="point_f[]" placeholder="Point Pilihan F" value="{{$data->point_f}}">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" step="0.1" class="form-control int" id="point_g" name="point_g[]" placeholder="Point Pilihan G" value="{{$data->point_g}}">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" step="0.1" class="form-control int" id="point_h" name="point_h[]" placeholder="Point Pilihan H" value="{{$data->point_h}}">
                      </div>
