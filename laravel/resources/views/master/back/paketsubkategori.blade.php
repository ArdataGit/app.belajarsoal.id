...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active"><a href="{{url('paketkategori')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a></li>
                    ...
                    <td width="1%" class="_align_center">
                      ...
                      <div class="btn-group">
                        ...
                        @php
                          ...
                          $cekdata = App\Models\PaketMst::where('fk_paket_subkategori',$key->id)->whereNull('deleted_by')->get();
                          // dd($cekdata);
                        @endphp
            ...
            <div class="modal-body">
              ...
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="judul_{{$key->id}}" name="judul[]" placeholder="Subkategori" value="{{$key->judul}}">
