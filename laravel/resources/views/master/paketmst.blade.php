                                        ...
                                        <tr>
                                            ...
                                            <td width="1%" class="_align_center">
                                                <div class="btn-group">
                                                    ...
                                                    @php
    $cekdata = App\Models\Transaksi::where('fk_paket_mst', $key->id)
        ...
        ->get();
                                                    ...
                                                    @else
                                                        <span data-toggle="tooltip" data-placement="left"
                                                            title="Data tidak bisa dihapus karena sudah ada yang membeli / sedang membeli paket ini">
                                                            <button type="button"
                                                                class="btn btn-sm btn-outline-danger disabled"><i
                                                                    class="far fa-trash-alt"></i></button>
                                                        </span>
                                                    @endif
                                                </div>
                    ...
                    <form method="post" id="formData_{{ $key->id }}" class="form-horizontal">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="fk_paket_kategori_{{ $key->id }}">Kategori Paket<span
                                        class="bintang">*</span></label>
                                <select class="form-control fk_paket_kategori" name="fk_paket_kategori[]"
                                    id="fk_paket_kategori_{{ $key->id }}"
                                    idsub="#fk_paket_subkategori_{{ $key->id }}">
                                    <option value=""></option>
                                    @foreach ($kategori as $keydata)
                                        <option value="{{ $keydata->id }}"
                                            {{ $keydata->id == $key->fk_paket_kategori ? 'selected' : '' }}>
                                            {{ $keydata->judul }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @php
    $subkategori = App\Models\PaketSubkategori::where(
        'fk_paket_kategori',
        $key->fk_paket_kategori,
    )->get();
                            @endphp
                            <div class="form-group">
                                <label for="fk_paket_subkategori_{{ $key->id }}">Subkategori Paket<span
                                        class="bintang">*</span></label>
                                <select class="form-control fk_paket_subkategori" name="fk_paket_subkategori[]"
                                    id="fk_paket_subkategori_{{ $key->id }}">
                                    <option value=""></option>
                                    @foreach ($subkategori as $keydata)
                                        <option value="{{ $keydata->id }}"
                                            {{ $keydata->id == $key->fk_paket_subkategori ? 'selected' : '' }}>
                                            {{ $keydata->judul }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="judul_{{ $key->id }}"
                                    name="judul[]" placeholder="Judul" value="{{ $key->judul }}">
                            </div>
                            <div class="form-group">
                                <label>Paket Gratis<span class="bintang">*</span></label>
                                <br>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input is_gratis" type="radio" name="is_gratis[]"
                                        value="1" harga="form-harga-{{ $key->id }}"
                                        {{ $key->is_gratis == 1 ? 'checked' : '' }}>
                                    <label class="form-check-label">Ya</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input is_gratis" type="radio" name="is_gratis[]"
                                        value="0" harga="form-harga-{{ $key->id }}"
                                        {{ $key->is_gratis == 0 ? 'checked' : '' }}>
                                    <label class="form-check-label">Tidak</label>
                                </div>
                                <br>
                            </div>
                            <!-- Input field untuk password -->
                            {{-- <div class="form-group {{ $key->is_gratis == 1 ? '' : 'd-none' }}"
                                id="form-password-{{ $key->id }}">
                                <label for="password_{{ $key->id }}">Password<span class="bintang">*</span></label>
                                <input type="text" class="form-control" id="password_{{ $key->id }}"
                                    name="password[]" placeholder="Password" value="{{ $key->password }}">
                            </div> --}}
                            <div class="form-group {{ $key->is_gratis == 1 ? 'd-none' : '' }}"
                                id="form-harga-{{ $key->id }}">
                                <label for="harga_{{ $key->id }}">Harga<span class="bintang">*</span></label>
                                <input type="text" class="form-control int" id="harga_{{ $key->id }}"
                                    name="harga[]" placeholder="Harga" value="{{ $key->harga }}">
                            </div>
                            <div class="form-group" id="form-jumlah-gratis-ujian-{{ $key->id }}">
                                <label for="jumlah_gratis_ujian_{{ $key->id }}">Jumlah Ujian Gratis<span
                                        class="bintang">*</span></label>
                                <input type="text" class="form-control int"
                                    id="jumlah_gratis_ujian_{{ $key->id }}" name="jumlah_gratis_ujian[]"
                                    placeholder="Jumlah Ujian Gratis" value="{{ $key->jumlah_gratis_ujian }}">
                            </div>
                            <div class="form-group" id="form-jumlah-gratis-belajar-{{ $key->id }}">
                                <label for="jumlah_gratis_belajar_{{ $key->id }}">Jumlah Belajar Gratis<span
                                        class="bintang">*</span></label>
                                <input type="text" class="form-control int"
                                    id="jumlah_gratis_belajar_{{ $key->id }}" name="jumlah_gratis_belajar[]"
                                    placeholder="Jumlah Belajar Gratis" value="{{ $key->jumlah_gratis_belajar }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="input-foto custom-file-input"
                                            id="banner_{{ $key->id }}" name="banner[]"
                                            idlabel="label-banner-{{ $key->id }}">
                                        <label id="label-banner-{{ $key->id }}" class="custom-file-label"
                                            style="border-radius: .25rem;">Pilih file</label>
                                    </div>
                                </div>
                            </div>
                            <!--     <div class="form-group">-->
                ...
                <form method="post" id="_formData" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control fk_paket_kategori" name="fk_paket_kategori_add"
                                id="fk_paket_kategori_add" idsub="#fk_paket_subkategori_add">
                                <option value=""></option>
                                @foreach ($kategori as $keydata)
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control fk_paket_subkategori" name="fk_paket_subkategori_add"
                                id="fk_paket_subkategori_add">
                                <option value=""></option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="judul_add">Judul<span class="bintang">*</span></label>
                            <input type="text" class="form-control" id="judul_add" name="judul_add"
                                placeholder="Judul">
                        </div>
                        <div class="form-group">
                            <label>Paket Gratis<span class="bintang">*</span></label>
                            <br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input is_gratis" type="radio" name="is_gratis_add"
                                    value="1" harga="form-harga-add">
                                <label class="form-check-label">Ya</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input is_gratis" type="radio" name="is_gratis_add"
                                    value="0" harga="form-harga-add">
                                <label class="form-check-label">Tidak</label>
                            </div>
                            <br>
                        </div>
                        ...
                        <div class="form-group d-none" id="form-harga-add">
                            ...
                            <input type="text" class="form-control int" id="harga_add" name="harga_add"
                                placeholder="Harga" value="0">
                        </div>
                        <div class="form-group" id="form-jumlah-gratis-ujian-add">
                            <label for="jumlah_gratis_ujian_add">Jumlah Ujian Gratis<span class="bintang">*</span></label>
                            <input type="text" class="form-control int" id="jumlah_gratis_ujian_add"
                                name="jumlah_gratis_ujian_add" placeholder="Jumlah Ujian Gratis" value="0">
                        </div>
                        <div class="form-group" id="form-jumlah-gratis-belajar-add">
                            <label for="jumlah_gratis_belajar_add">Jumlah Belajar Gratis<span
                                    class="bintang">*</span></label>
                            <input type="text" class="form-control int" id="jumlah_gratis_belajar_add"
                                name="jumlah_gratis_belajar_add" placeholder="Jumlah Belajar Gratis" value="0">
                        </div>
                        <!-- <label>Tanggal<span class="bintang">*</span></label>
                                                                          <div class="row">
                                                                            <div class="col-6">
                        ...
                        <div class="form-group">
                            <label>Banner<span class="bintang"></span> <span
                                    class="input-keterangan">(jpg/jpeg/png)</span></label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="input-foto custom-file-input" id="banner_add"
                                        name="banner_add" idlabel="label-banner-add">
                                    <label id="label-banner-add" class="custom-file-label"
                                        style="border-radius: .25rem;">Pilih file</label>
                                </div>
                            </div>
                        </div>
