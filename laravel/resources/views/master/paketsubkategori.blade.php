...
@section('contentheader')
    <h1 class="m-0">{{ $kategori->judul }}</h1>
@endsection
...
@section('contentheadermenu')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active"><a href="{{ url('paketkategori') }}"><i class="fa fa-arrow-left"
                                            ...
                                            <td width="1%" class="_align_center">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    @php
                                                        ...
                                                        $cekdata = App\Models\PaketMst::where(
                                                    ...
                                                    @else
                                                        <span data-toggle="tooltip" data-placement="left"
                                                            title="Harap hapus paket yang menggunakan subkategori ini terlebih dahulu">
                    ...
                    <form method="post" id="formData_{{ $key->id }}" class="form-horizontal">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <label for="judul_{{ $key->id }}">Subkategori<span class="bintang">*</span></label>

                                <input type="text" class="form-control" id="judul_{{ $key->id }}" name="judul[]"
                                    placeholder="Subkategori" value="{{ $key->judul }}">
                ...
                <div class="modal-content">
                    ...
                    <form method="post" id="formHapus_{{ $key->id }}" class="form-horizontal">
                        ...
                        <div class="modal-body">
                            ...
                            <h6> Apakah anda ingin menghapus subkategori {{ $key->judul }}?</h6>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <form method="post" id="_formData" class="form-horizontal">
                    ...
                    <input type="hidden" name="fk_paket_kategori" id="fk_paket_kategori" value="{{ $id }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-hapus', function(e) {
                ...
                var url = "{{ url('/hapuspaketsubkategori') }}/" + idform;
            ...
            $(document).on('click', '.btn-submit-data', function(e) {
                ...
                $('#formData_' + idform).validate({
                    ...
                    submitHandler: function() {
                        ...
                        var url = "{{ url('/updatepaketsubkategori') }}/" + idform;
            ...
            $('#_formData').validate({
                ...
                submitHandler: function() {
                    ...
                    var url = "{{ url('storepaketsubkategori') }}";
