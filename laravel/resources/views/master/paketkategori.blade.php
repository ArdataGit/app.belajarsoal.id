                                            ...
                                            <td width="1%" class="_align_center">
                                                <div class="btn-group">
                                                    <span data-toggle="tooltip" data-placement="left" title="Subkategori">
                                                        <a href="{{ url('paketsubkategori') }}/{{ $key->id }}"
                                                    ...
                                                    @php
                                                        $cekdata = App\Models\PaketSubkategori::where(
                                                            'fk_paket_kategori',
                                                            $key->id,
                                                        )->get();
                                                    @endphp
                                                    ...
                                                    @else
                                                        <span data-toggle="tooltip" data-placement="left"
                                                            title="Harap hapus subkategori terlebih dahulu">
                                                            <button type="button"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="judul_{{ $key->id }}" name="judul[]"
                                    placeholder="Kategori" value="{{ $key->judul }}">
                            </div>
                            <div class="form-group">
