          ...
          <div class="col-12">
            <div class="card">
              ...
              <ul class="kategori">
                ...
                <button data-toggle="modal" data-target="#modal-tambah" type="button" class="btn btn-md btn-primary"><i class="fa fa-plus"></i></button>
                </li>
                @php 
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form method="post" id="formHapus_{{$id}}" class="form-horizontal">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                <button type="submit" class="btn btn-danger btn-hapus" idform="{{$id}}">Hapus</button>
            </div>
          </form>
        </div>
      <!-- /.modal-content -->
